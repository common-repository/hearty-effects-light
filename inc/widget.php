...
class HeartyEffectsLightWidget extends WP_Widget {

	function __construct() {

		$widget_options = array(
			'classname' => 'heartyeffectslight_widget',
			'description' => 'Displays a HeartyEffectsLight instance',
		);

		parent::__construct( 'heartyeffectslight_widget', 'HeartyEffectsLight Widget', $widget_options );
